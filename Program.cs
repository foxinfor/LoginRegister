    ...
    public class Program
    {
        ...
        private static async Task InitialiseGoods(ApplicationDbContext context)
        {
            if (!context.Goods.Any())
            {
                ...
                {
                    new Goods { Name = "Куртка", Count = 10, ImageSrc = "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRVQHyhlYKuD1Iye86vZ3uzqqFkSQsY9yAyug_0APjACX0RRDK6bYj1JeOtFAYln2U0BfQEL6cpfCb6wuufQOEtbYPTZ9wHffNmc0VT079hEEVYoTufwcOOoihfcCK0ujYXjIjtflQ&usqp=CAc", CategoryId = 1 },
